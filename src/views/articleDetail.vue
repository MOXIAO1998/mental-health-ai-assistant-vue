    ...
    <div class="articleDetail-container">
        <div class="header-section">
            <div class="header-content">
                ...
                <h1>Knowledge Article Detail</h1>
            </div>
        </div>
        <div class="content">
            <div class="diary-card">
                <p class="title">Article Information</p>
                <div class="sub-title">
                    <el-tag size="large" class="category-tag">{{ translateCategory(articleDetail.categoryName) }}</el-tag>
                    <div class="flex-box">
                ...
                <div :style="{marginTop: '20px'}" class="flex-box">
                   <div class="item flex-box">
                    ...
                    <div class="item flex-box">
                        ...
                        <span>View Times: {{ articleDetail.readCount }} </span>
                    </div>
                </div>
            </div>
            <div class="diary-card">
